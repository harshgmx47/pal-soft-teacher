import '../features/daily-quiz/model/questions.dart';

final String appName = "Prashnottari";
final String packageName = "com.palsoft.prashnottari";
...
//
final String defaultLanguageCode = 'na'; //default 'en'
...
//educationPofileBox
//
final String eduboardBoxKey = "board";
final String eduSchoolBoxKey = "school";
final String eduStandardBoxKey = "standard";
final String eduMediumBoxKey = "medium";
final String eduStatusBoxKey = "status";
///////////
...
final String databaseUrl = "http://quizadmin.palsoft.co.in";
...
//// DailyQuiz Dummy Data
///
///
final selectedItem = <QuestionModel>[];
final questionsList = <QuestionModel>[
  QuestionModel(title: "foootbal", isChecked: false),
  QuestionModel(title: "basketball", isChecked: false),
  QuestionModel(title: "hocky", isChecked: false),
  QuestionModel(title: "basketball", isChecked: false),
];
