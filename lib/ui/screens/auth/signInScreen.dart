...
import 'package:pal_prashnotarri_teacher/ui/screens/auth/widgets/termsAndCondition.dart';
import 'package:pal_prashnotarri_teacher/ui/styles/colors.dart';
import 'package:pal_prashnotarri_teacher/ui/widgets/customRoundedButton.dart';
import 'package:pal_prashnotarri_teacher/ui/widgets/pageBackgroundGradientContainer.dart';
import 'package:pal_prashnotarri_teacher/utils/uiUtils.dart';
import 'package:pal_prashnotarri_teacher/utils/validators.dart';
  ...
  Widget showSignIn(BuildContext context) {
    return Container(
      ...
      child: CupertinoButton(
        ...
        color: Theme.of(context).primaryColor,
        onPressed: (() {
          if (edtEmail.text.trim() == "xyz@gmail.com" &&
              edtPwd.text.trim() == "12345678") {
